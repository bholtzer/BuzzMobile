...
class SosForegroundService : Service() {
    ...
    companion object {
        const val ACTION_START_MONITORING = " com.bih.mangosos.action.START_MONITORING"
        const val ACTION_STOP_MONITORING = " com.bih.mangosos.action.STOP_MONITORING"
        const val ACTION_SYNC_NOTIFICATION = " com.bih.mangosos.action.SYNC_NOTIFICATION"
        const val ACTION_STOP_SOS = " com.bih.mangosos.action.STOP_SOS"
